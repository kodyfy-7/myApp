            ...
            <div class="col-md-3 left_col">
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <ul class="nav side-menu">
                        <li><a href="/teacher"><i class="fa fa-dashboard"></i> Dashboard</a></li>
						<li><a href="/teacher/student-assignments"><i class="fa fa-folder-open-o"></i> Assignments</a></li>
                        <li><a><i class="fa fa-folder-open"></i> Results <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu" style="display: none">
							<li><a href="/teacher/ca"> Continous Assesment</a></li>
							<li><a href="/teacher/exam"> Examination</a></li>
                        </ul>
						</li>
						@if (App\Employee::find(Auth::user()->employee_id)->classroom = '')
