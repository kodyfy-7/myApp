            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    {!! Form::open(['action' => 'StudentsAttendanceController@store', 'id' => 'attendance_form', 'method' =>'POST']) !!}
                        ...
                        <input class="btn btn-primary btn-block" type="submit" value="Submit Attendance" name="submit_attendance">
                    {!! Form::close() !!}
                </div>
              </div>
            </div>
