                        ...
                        <div class="dropdown dropright">
                            ...
                            <div class="dropdown-menu">
                                ...
                                @forelse($classrooms as $classroom)
                                        <a class="dropdown-item" href="/teacher/ca/{{$classroom->id}}">{{$classroom->title}}</a>
                          ...
                          <tbody>
                              @foreach ($students as $student)
                                @foreach ($student->results as $result)
                                  ...
                                  <tr>
                                  <td><input type="text" value="{{$student->name}}" class="form-control" disabled></td>
                                      <td>{{Form::text('score[]', '', ['id' => 'score', 'class' => 'form-control'])}}{{Form::hidden('classroom_id[]', $id, ['id' => 'classroom_id', 'class' => 'form-control'])}} <input type="hidden" name="result_id[]" id="result_id" value="{{$result->id}}" /></td>
                                  </tr>  
                                  @endforeach                                                 
                              @endforeach
                          </tbody>
