		...
		<div class="main_container">
            <div class="col-md-3 left_col">
                ...
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{route('admin.dashboard')}}" class="site_title"><i class="fa fa-paw"></i> <span>{{ config('School', 'School') }}</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    ...
                    <ul class="nav side-menu">
						...
						<li><a href="{{route('employees.index')}}"><i class="fa fa-user"></i> Employees</a></li>
						<li><a href="{{route('subjects.index')}}"><i class="fa fa-book"></i> Subjects</a></li>
                        <li><a><i class="fa fa-sitemap"></i> Classrooms <span class="fa fa-chevron-down"></span></a>
						<ul class="nav child_menu" style="display: none">
							<li><a href="{{route('classrooms.index')}}"> Classrooms</a></li>
