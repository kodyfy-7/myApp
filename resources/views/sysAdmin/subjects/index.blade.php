          ...
          <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
              <div class="input-group">
                <button type="button" name="create_record" id="create_record" class="btn btn-primary btn-block">Add a new subject</button>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                {{Form::select('level', ['JN' => 'Junior', 'Sn' => 'Senior'], '', ['id' => 'level', 'class' => 'form-control', 'placeholder' => 'Select Junior or Senior'])}}                          
                            </div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function(){        
            ...
            $('#create_record').click(function(){
                $('.modal-title').text("Add a new subject");
                ...
                $(document).on('click', '.edit', function(){
                    ...
                    $.ajax({
                        ...
                        success:function(html){
                            $('#title').val(html.data.subject_title);
                            $('#level').val(html.data.level);
                            $('#teacher').val(html.data.employee_id);
                            $('#hidden_id').val(html.data.id);
                            $('.modal-title').text("Edit Subject details");
