                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              {{Form::select('class_teacher', App\Employee::pluck('name', 'id'), '',['id' => 'class_teacher', 'class' => 'form-control', 'placeholder' => ''])}}
                          </div>
                            <div class="form-group">
                                {{Form::label('category', 'Category')}}
                                {{Form::select('category', ['N' => 'None', 'Sc' => 'Science', 'Cm' => 'Commercial', 'Ar' => 'Arts'], '', ['id' => 'category', 'class' => 'form-control', 'placeholder' => 'Select class category'])}}               
                            </div>
                            <table id="subject_table" class="table">
                                ...
                                <tr>
                                    <td>
                                        <select name="subject[]" class="form-control" id="subject1">
                                            <option value="">Select subject</option>
                                            @foreach($subjects as $subject)
                                                <option value="{{$subject->id}}">{{$subject->subject_title}} <small> |{{$subject->level}}</small>
                                                </option>
                                            @endforeach
                                        </select>                                            
                                    </td>
    ...
    <script>
        $(document).ready(function(){        
            ...
            $(document).on('click', '#add_row', function(){
                ...
                html_code += '<td><select name="subject[]" class="form-control" id="subject'+count+'"><option value="">Select subject</option>@foreach($subjects as $subject)<option value="{{$subject->id}}">{{$subject->subject_title}} <small>| {{$subject->level}}</small></option>                                        @endforeach</select>      </td>';           
