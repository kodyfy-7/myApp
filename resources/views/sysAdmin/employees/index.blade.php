          ...
          <div class="title_right">
            <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
              <div class="input-group">
                <button type="button" name="create_record" id="create_record" class="btn btn-primary btn-block">Add a new employee</button>
              </div>
            </div>
          </div>
        </div>
                      ...
                      <div class="modal-body">
                            <p class="text-muted font-13 m-b-30"><span id="form_result"></span></p>                      
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('name', '', ['id' => 'name', 'class' => 'form-control', 'placeholder' => ''])}}
                                </div>
                                <div class="form-group">
                                    {{Form::label('designation', 'Designation')}}
                                    {{Form::select('designation', ['1' => 'Admin', '2' => 'Teacher'],'', ['id' => 'designation', 'class' => 'form-control', 'placeholder' => ''])}}                          
                                </div>
